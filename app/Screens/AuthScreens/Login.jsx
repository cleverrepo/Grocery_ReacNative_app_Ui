  ...
  return (
    ...
    resizeMode='fill'>
      <View style={styles.container1}>
        ...
        <Text style={{fontSize:20,color:"white", fontWeight:"900"}}>Enter your Email and password to access your account or create another account  </Text>
      </View>
      <View style={styles.container2}>
        ...
        <TouchableOpacity style={styles.btn} onPress={()=>navigation.navigate("BottomBar")}>
          <Text style={{fontSize:20,color:"black", fontWeight:"900",color:"white"}}>Sign In</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={()=>navigation.navigate("Register")}>
        <Text style={{textAlign:"center", color:"black", fontSize:22}}> Don't have an account</Text>
        </TouchableOpacity>
